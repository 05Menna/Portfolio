...
function Hero() {
    return (
        ...
        >
            ...
            <div className="relative z-10 max-w-7xl mx-auto px-8 lg:px-16 pt-10">
                ...
                <div className="min-h-screen flex flex-col-reverse lg:flex-row items-center justify-between gap-20">
                    ...
                    <div className="flex-1 flex justify-center">
                        ...
                        >
                            ...
                            {/* Ring 2 */}
                            {/* <div className="absolute inset-0 rounded-full border-2 border-cyan-500/30 scale-125 animate-[spin_25s_linear_infinite]" /> */}
                            {/* Ring 3 */}
                            {/* <div className="absolute inset-0 rounded-full border border-purple-500/20 scale-[1.42] animate-[spin_35s_linear_infinite_reverse]" /> */}
